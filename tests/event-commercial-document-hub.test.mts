...
test("mobile is inline touch friendly and OC reuses the canonical MobileDialog",()=>{assert.match(hub,/grid min-w-0 gap-2 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5/);assert.match(hub,/min-h-11/);assert.match(hub,/CustomerPurchaseOrderCenter/)});
