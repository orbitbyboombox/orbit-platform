...
export function OrbitLoader({variant="inline",label="Cargando…",className}:OrbitLoaderProps){
  const ring=<span aria-hidden="true" className={cn("orbit-loader-ring shrink-0",sizes[variant])}/>;
