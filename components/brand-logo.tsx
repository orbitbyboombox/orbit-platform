...
export function BrandLogo({ variant = "horizontal", surface = "auto", className, priority }: BrandLogoProps) {
  ...
  const configuredSource=(isIsotype?settings.isotypeUrl:"/branding/boombox-official-logo.png").replaceAll("%20"," ");
  const fallbackSource=isIsotype?"/branding/orbit-isotype.png":"/branding/boombox-official-logo.png";
