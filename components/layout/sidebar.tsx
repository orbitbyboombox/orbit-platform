...
export function NavigationList({ onNavigate, compact, navigationOrder, hiddenNavigation = [] }: NavigationListProps) {
...
export function Sidebar({ navigationOrder, hiddenNavigation }: Pick<NavigationListProps,"navigationOrder"|"hiddenNavigation">) {
  return (
    <aside className="fixed inset-y-0 left-0 z-30 hidden w-20 border-r bg-card transition-[width] md:flex md:flex-col lg:w-60">
      ...
      <div className="px-3 pb-3 pt-1.5"><NavigationList compact hiddenNavigation={hiddenNavigation} navigationOrder={navigationOrder} /></div>
