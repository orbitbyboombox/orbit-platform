-- staff_onboarding_documents.applicable_month is a YYYY-MM text field.
-- Keep the canonical Staff boleta document linked to that exact month format.
...
begin
  ...
  values(null,p_staff_id,'BOLETA_HONORARIOS','BOLETAS',to_char(date_trunc('month',p_month),'YYYY-MM'),'Boleta de honorarios','ACTIVE',p_bucket,p_path,p_file_name,p_mime_type,p_actor)
