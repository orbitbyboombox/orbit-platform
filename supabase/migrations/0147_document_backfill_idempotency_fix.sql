...
-- 0147: Align backfill idempotency with production schema constraint.
-- Scope: execution behavior only.
-- - No automatic historical repair.
-- - No financial/payment/revenue mutation.
-- - No storage or drive mutation.
