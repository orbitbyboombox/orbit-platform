...
export default async function CashFlowPage(){
  ...
  const[paymentsResult,invoicesResult,expensesResult,staffEventsResult,fuelResult,vehiclesResult]=await Promise.all([
  ...
  const error=paymentsResult.error??invoicesResult.error??expensesResult.error??staffEventsResult.error??fuelResult.error??vehiclesResult.error;if(error)throw error;
