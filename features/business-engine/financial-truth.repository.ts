...
export interface FinancialTruthRecord {
  ...
  revenue:number;estimatedCost:number;realCost:number;grossProfit:number;grossMargin:number;netProfit:number;netMargin:number;invoicedAmount:number;paidAmount:number;outstandingBalance:number;
