export const PIPELINE_STAGES = ["NUEVO", "CALIFICANDO", "COTIZACIÓN", "SEGUIMIENTO", "RESERVA PENDIENTE", "GANADO", "PERDIDO", "CANCELADO", "PRUEBA", "ARCHIVADO"] as const;
...
export interface SalesPipelineData { leads: readonly SalesLead[]; counts: Readonly<Record<PipelineStage, number>>; metrics: { newLeads: number; quotes: number; reservations: number; won: number; lost: number; cancelled?: number; estimatedValue: number; overdue: number; }; }
