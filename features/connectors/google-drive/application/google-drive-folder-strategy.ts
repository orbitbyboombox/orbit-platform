...
export function resolveAutomaticDestination(request: GoogleDriveDestinationRequest,rootName=DEFAULT_GOOGLE_DRIVE_ROOT): GoogleDriveDestination {
  ...
  const customerMap = { CONTRACT: "01_Contrato", QUOTATION: "03_Cotizaciones", PAYMENT_PROOF: "02_Comprobantes", DESIGN: "04_Diseños", PHOTO: "05_Fotografías", DELIVERY: "09_Documentos", CUSTOMER_HISTORY: "09_Documentos" } as const;
