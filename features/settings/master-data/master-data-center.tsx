...
const SECTIONS: readonly { id: MasterDataDomain; label: string; description: string; icon: typeof Settings2 }[] = [
  ...
  { id: "COSTS", label: "Costos operacionales", description: "Fuente oficial para papel, producción, operadores, montaje, combustible y otros costos.", icon: CircleDollarSign },
...
export function MasterDataCenter({ canEdit, costMaster, equipmentCount, records, role, services, staffCount, transportZones, venues }: MasterDataProjection) {
