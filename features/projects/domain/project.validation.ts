...
export const projectSchema: z.ZodType<Project> = z.object({
  ...
  eventTime: z.string().regex(timePattern, "Expected time in HH:mm or HH:mm:ss format.").nullable(),
  eventTimeMode: z.enum(["CONFIRMED", "TBD"]),
  eventTimeWindow: z.enum(["MORNING", "AFTERNOON", "EVENING", "UNKNOWN"]),
  eventTimeConfirmationDeadline: z.string().nullable(),
