...
const routeModules:[string,OrbitModuleKey][]=[["/office-rent","FINANCE"],["/finance","FINANCE"],["/reports","REPORTS"],["/resources/staff","STAFF"],["/resources","RESOURCES"],["/tasks","OPERATIONS"],["/notifications","OPERATIONS"],["/projects","PROJECTS"],["/operations","DASHBOARD"]];
