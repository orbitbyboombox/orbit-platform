...
const common: Readonly<Record<QuotationExtraId, QuotationExtraRule>> = {
  ...
  SCRAPBOOK: { id: "SCRAPBOOK", label: "Scrapbook", price: clp(55_000) },
...
export function getQuotationExtras(eventType: EventTypeId): readonly QuotationExtraRule[] {
  if (eventType === "WEDDING") return [{ ...common.SCRAPBOOK, included: true, price: clp(0) }, common.UNLIMITED_MAGNETS, common.ADDITIONAL_HOUR, common.ADDITIONAL_TRANSPORT];
  if (eventType === "BIRTHDAY" || eventType === "GRADUATION") return [common.UNLIMITED_MAGNETS, common.SCRAPBOOK, common.ADDITIONAL_HOUR, common.ADDITIONAL_TRANSPORT];
  if (eventType === "COMPANY" || eventType === "PUBLIC_EVENT") return [common.BRANDING, common.QR, common.UNLIMITED_MAGNETS, common.ADDITIONAL_HOUR, common.ADDITIONAL_TRANSPORT];
